...
public class signUpInput {
  ...
  public String toString() {
    return "signUpInput{id='" + id + "', idType='" + idType + "', city='" + city + "', gender='" + gender + "', role='" + role + "', identificationNumber='" + identificationNumber + "', firstName='" + firstName + "', lastName='" + lastName + "', birthDate='" + birthDate + "', phoneNumber='" + phoneNumber + "', email='" + email + "', password='" + password + "', avatarUrl='" + avatarUrl + "', address='" + address + "'}";
  }
  ...
  public static class Builder {
    ...
    public Builder idType(int idType) {
      this.idType = idType;
      return this;
    }
